...
/* harmony import */ var _util_Util__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("XOHG");
...
function (_React$Component) {
  ...
  function SearchInputGroup() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"])(_this), "filterString", function (str) {
      return Object(_util_Util__WEBPACK_IMPORTED_MODULE_8__[/* sanitizeString */ "d"])(_this.state.squadSearch).split(/[ ,]+/).filter(Boolean).join(',');
    });
...
// CONCATENATED MODULE: ./components/common/Separator.js
...
var Util = __webpack_require__("XOHG");
  ...
  Object(createClass["default"])(SquadMemberCard, [{
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement("div", {
        ...
        top10s: top10s,
        kills: kills
      }), external_react_default.a.createElement(Separator, {
        color: "secondary",
        margin: "0",
        length: "12"
  ...
  return function (dispatch, getState) {
    ...
    if (squad.split(',').length < 2) {
      ...
      external_axios_default.a.get('/api/stats', {
        ...
        dispatch({
          type: types["a" /* GET_PLAYER_SEASONS */],
          payload: payload
        });
      })["catch"](function (err) {
        dispatch({
...
var togetherStatsActions_setSquadMembers = function setSquadMembers(squadMembersArray) {
  return {
    type: types["m" /* SET_SQUAD_MEMBERS */],
...
var togetherStatsActions_setSquadGameMode = function setSquadGameMode(mode) {
  return function (dispatch) {
    dispatch({
      type: types["l" /* SET_SQUAD_GAME_MODE */],
      payload: mode
    });
  };
};
var togetherStatsActions_setSquadPerspective = function setSquadPerspective(perspective) {
  return function (dispatch) {
    dispatch({
      type: types["p" /* SET_SQUAD_PERSPECTIVE */],
      payload: perspective
    });
  };
};
...
var togetherStatsActions_setSquadStatsLoading = function setSquadStatsLoading() {
  return {
    type: types["c" /* LOADING_SQUAD_STATS */]
  };
};
var togetherStatsActions_getSquadStats = function getSquadStats() {
  return function (dispatch, getState) {
    ...
    external_axios_default.a.post('/api/stats/matches', {
      ...
      dispatch({
        type: types["b" /* GET_SQUAD_STATS */],
        payload: res.data
      });
    })["catch"](function (err) {
      dispatch({
        type: types["k" /* SET_SQUAD_ERROR */],
        payload: err.response.data
      });
    });
  };
...
function (_Component) {
  ...
  Object(createClass["default"])(TogetherStats, [{
    ...
    value: function render() {
      ...
      }, external_react_default.a.createElement(SquadStats_PlayerPicker, null), external_react_default.a.createElement(SquadStats_SquadSearch, null), external_react_default.a.createElement(Separator, {
        color: "secondary",
        length: 10,
        margin: 4
...
function (_Component) {
  ...
  function StatsDashboard() {
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "fetchPlayerSeasons", function () {
      var squadMates = Object(Util["d" /* sanitizeString */])(_this.props.squad).split(',').filter(function (el) {
        return el != null;
      }).join(',');
  ...
  Object(createClass["default"])(StatsDashboard, [{
    ...
    value: function getDerivedStateFromProps(nextProps, prevState) {
      var newSquadMates = Object(Util["d" /* sanitizeString */])(nextProps.squad).split(',').filter(function (el) {
        return el != null;
      }).join(',');
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return sanitizeString; });
/* harmony import */ var lodash_intersectionby__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("Wpmc");
...
function index(_ref) {
  ...
  }, external_react_default.a.createElement(layout_Header, null), children, external_react_default.a.createElement(layout_Footer, null));
}
